...
import { commentFields, commentInferRemainingFields } from './comment.schema';

@Component({
  selector: 'app-ivr-module-details-comment',
  standalone: true,
...
export class IvrModuleDetailsCommentComponent extends IvrModuleDetailsBaseDirective {
  readonly fields = commentFields;
  readonly inferRemainingFields = commentInferRemainingFields;
}
