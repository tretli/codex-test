...
import { macroFields, macroInferRemainingFields } from './macro.schema';
...
export class IvrModuleDetailsMacroComponent extends IvrModuleDetailsBaseDirective {
  readonly fields = macroFields;
  readonly inferRemainingFields = macroInferRemainingFields;
}
