...
import { waitFields, waitInferRemainingFields } from './wait.schema';
...
export class IvrModuleDetailsWaitComponent extends IvrModuleDetailsBaseDirective {
  readonly fields = waitFields;
  readonly inferRemainingFields = waitInferRemainingFields;
}
