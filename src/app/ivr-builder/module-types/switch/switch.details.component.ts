...
import { switchFields, switchInferRemainingFields } from './switch.schema';
...
export class IvrModuleDetailsSwitchComponent extends IvrModuleDetailsBaseDirective {
  readonly fields = switchFields;
  readonly inferRemainingFields = switchInferRemainingFields;
}
