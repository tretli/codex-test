...
import { noOpFields, noOpInferRemainingFields } from './no-op.schema';

@Component({
  selector: 'app-ivr-module-details-no-op',
  standalone: true,
...
export class IvrModuleDetailsNoOpComponent extends IvrModuleDetailsBaseDirective {
  readonly fields = noOpFields;
  readonly inferRemainingFields = noOpInferRemainingFields;
}
