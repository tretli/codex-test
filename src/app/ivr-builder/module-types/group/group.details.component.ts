...
import { groupFields, groupInferRemainingFields } from './group.schema';
...
export class IvrModuleDetailsGroupComponent extends IvrModuleDetailsBaseDirective {
  readonly fields = groupFields;
  readonly inferRemainingFields = groupInferRemainingFields;
}
