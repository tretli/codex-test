...
import { readDtmfFields, readDtmfInferRemainingFields } from './read-dtmf.schema';
...
export class IvrModuleDetailsReadDtmfComponent extends IvrModuleDetailsBaseDirective {
  readonly fields = readDtmfFields;
  readonly inferRemainingFields = readDtmfInferRemainingFields;
}
