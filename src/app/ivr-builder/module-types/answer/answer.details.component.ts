...
import { answerFields, answerInferRemainingFields } from './answer.schema';

@Component({
  selector: 'app-ivr-module-details-answer',
  standalone: true,
...
export class IvrModuleDetailsAnswerComponent extends IvrModuleDetailsBaseDirective {
  readonly fields = answerFields;
  readonly inferRemainingFields = answerInferRemainingFields;
}
